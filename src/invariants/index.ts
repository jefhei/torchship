 ...
 * hatch-alignment stub into LIVE_CHECKS and M2-T7 wired room-lit (the authored
 * kit's light sockets); M3-T2/M3-T3/M3-T6 do the same for their bullets — the
 * registry entry is the contract each real check slots into.
 */
