 ...
 * galley/bunk (`galley`), the ops deck (`ops`), engineering (`engineering`),
 * the long-haul hold (`storage`) and the vertical trunk (`spine`, the shaft
 * band the assembler instantiates once per deck — the only module no spec ref
 * names).
 */
